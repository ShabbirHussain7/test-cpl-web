...
// Parse frontmatter
const reports = Object.values(markdownFiles).map((raw) => {
      ...
      <div className="page-container">
        ...
        <div className="pt-4 pb-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 ">
            <div className="relative w-full mx-auto md:w-auto bg-white bg-opacity-90 rounded-full border shadow-sm">
              <Search className="absolute left-3 top-2.5 h-5 w-5 text-gray-400 " />
              <input
                type="text"
                placeholder="Search by keyword..."
                className="pl-10 pr-4 py-2 border rounded-full md:w-180 "
                value={search}
        ...
        <section className=" grid grid-cols-1 md:grid-cols-3 gap-8 pb-6">
          {reports
