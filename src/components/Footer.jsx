      ...
      <div className="mt-6 flex flex-col lg:flex-row justify-between gap-8 font-inter">
        ...
        <div className="grid grid-cols-2 gap-8 text-[16px]">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link to="https://data.censoredplanet.org/" target="_blank" rel="noopener noreferrer" className="pl-4 hover:underline">Raw Data</Link>
            <Link to="https://docs.censoredplanet.org/" target="_blank" rel="noopener noreferrer" className="pl-4 hover:underline">Documentation</Link>
